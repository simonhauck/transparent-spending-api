...
class ImportAccountControllerApi {

  final Dio _dio;

  final Serializers _serializers;

  const ImportAccountControllerApi(this._dio, this._serializers);
  ...
  Future<Response<String>> importAccountByReference({ 
    required String ref,
    ...
    final _path = r'/registration/import/success';
